                            ...
                            <div className="col">
                                <form>
                                    <div className="form-group">
                                        ...
                                        <input type="file" className="form-control-file" id="exampleFormControlFile1" accept=".jpg, .jpeg, .png"/>
                                    </div>
                                </form>
                            </div>
                            <div className="col">
...
function Dashboard({ userInfo, updateUser }) {
        ...
        <div>
            <nav className="navbar navbar-expand-lg" style={navStyle}>
                <div className="container-fluid">
                    ...
                    <form className="form-inline">
                        <Link to='/history' className="btn btn-outline-success my-2 my-sm-0" type="submit">History</Link>
                        {/* <Link to='/' className="btn btn-outline-success my-2 my-sm-0" type="submit" onSubmit={handleSubmit}>LogOut</Link> */}
